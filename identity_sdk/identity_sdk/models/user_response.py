...
class UserResponse(BaseModel):
    ...
    must_change_password: StrictBool
    __properties: ClassVar[List[str]] = ["id", "status", "first_name", "middle_name", "last_name", "email", "phone_number", "country", "birthday", "created_at", "updated_at", "deleted_at", "deleted_by", "must_change_password"]
