...
class ValidateIdentifierOTPRequest(BaseModel):
    """
    ValidateIdentifierOTPRequest
    """ # noqa: E501
    identifier_id: StrictStr
    otp_code: Annotated[int, Field(le=999999, strict=True, ge=100000)] = Field(description="6-digit OTP code")
    __properties: ClassVar[List[str]] = ["identifier_id", "otp_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identifier_id": obj.get("identifier_id"),
