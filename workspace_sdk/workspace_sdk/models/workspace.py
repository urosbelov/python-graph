...
class Workspace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "base62_id", "status", "created_by", "created_at", "updated_at", "deleted_at", "deleted_by", "type", "name", "handle", "description", "category_id", "formatted_address", "avatar_id", "cover_id", "location"]
