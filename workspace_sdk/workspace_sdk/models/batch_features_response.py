...
class BatchFeaturesResponse(BaseModel):
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.features:
            for _key_features in self.features:
                if self.features[_key_features] is not None:
                    _field_dict_of_array[_key_features] = [
                        _item.to_dict() for _item in self.features[_key_features]
                    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": dict(
                (_k,
                        [FeatureResponse.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
