...
class MediaFilters(BaseModel):
    ...
    owner_service: Optional[StrictStr] = None
    owner_id: Optional[StrictStr] = None
    category: Optional[MediaCategory] = None
    __properties: ClassVar[List[str]] = ["status", "owner_service", "owner_id", "category"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if owner_service (nullable) is None
        # and model_fields_set contains the field
        if self.owner_service is None and "owner_service" in self.model_fields_set:
            _dict['owner_service'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner_service": obj.get("owner_service"),
